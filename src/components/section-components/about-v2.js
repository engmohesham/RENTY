			      ...
			      <div className="col-lg-6 align-self-center">
			        <div className="about-us-info-wrap">
			          ...
			          <ul className="ltn__list-item-2 ltn__list-item-2-before--- ltn__list-item-2-img mb-50">
			            <li>
			              <a href={publicUrl+"assets/img/img-slide/11.png"} data-rel="lightcase:myCollection">
			                <img src={publicUrl+"assets/img/img-slide/11.png"} alt="Image" />
			              </a>
			            </li>
			            <li>
			              <a href={publicUrl+"assets/img/img-slide/12.png"} data-rel="lightcase:myCollection">
			                <img src={publicUrl+"assets/img/img-slide/12.png"} alt="Image" />
			              </a>
			            </li>
			            <li>
			              <a href={publicUrl+"assets/img/img-slide/13.png"} data-rel="lightcase:myCollection">
			                <img src={publicUrl+"assets/img/img-slide/13.png"} alt="Image" />
			              </a>
			            </li>
			          </ul>
			        </div>
