					...
					<div className="shoping-cart-inner">
						...
						<table className="table">
							...
							<tr>
								...
								<td className="cart-product-image col-lg-2">
								<Link to="/product-details/"><img src={publicUrl+"assets/img/product/1.png"} alt="#" /></Link>
								</td>
								<td className="cart-product-info col-lg-3">
								<h4 className="go-top"><Link to="/product-details/">Brake Conversion Kit</Link></h4>
								</td>
								<td className="cart-product-price col-lg-2">$85.00</td>
								<td className="cart-product-stock col-lg-2">In Stock</td>
								<td className="cart-product-add-cart col-lg-3">
								<Link className="submit-button-1" to="/product-details" title="Details">Details</Link>
								</td>
							</tr>
							<tr>
								<td className="cart-product-remove">x</td>
								...
								<td className="cart-product-price col-lg-2">$89.00</td>
								<td className="cart-product-stock col-lg-2">In Stock</td>
								<td className="cart-product-add-cart col-lg-3">
								<Link className="submit-button-1" to="/product-details" title="Details">Details</Link>
								</td>
							...
							<tr>
								...
								<td className="cart-product-price col-lg-2">$149.00</td>
								<td className="cart-product-stock col-lg-2">In Stock</td>
								<td className="cart-product-add-cart col-lg-3">
								<Link className="submit-button-1" to="/product-details" title="Details">Details</Link>
								</td>
