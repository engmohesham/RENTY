			                ...
			                <div className="slide-item-info">
			                  <div className="slide-item-info-inner ltn__slide-animation">
			                    ...
			                    <div className="btn-wrapper animated">
			                      <Link to="/contact" className="theme-btn-1 btn-effect-4 btn btn-effect-1">Make An Enquiry</Link>
			              ...
			              <div className="col-lg-12 align-self-center">
			                <div className="slide-item-info">
			                  <div className="slide-item-info-inner ltn__slide-animation">
			                    ...
			                    <div className="btn-wrapper animated">
			                      <Link to="/login" className="theme-btn-1 btn btn-effect-4">DETAILS</Link>
			                      <Link to="/about" className="btn btn-transparent btn-effect-3">LEARN MORE</Link>
			                    </div>
			                  </div>
			                </div>
			                <div className="slide-item-img">
			                  <img src={publicUrl+"assets/img/slider/62.png"} alt="#" />
			                </div>
			              </div>
			            </div>
			          </div>
			          ...
			          <div className="container">
			            <div className="row">
			              <div className="col-lg-12 align-self-center">
			                ...
			                <div className="slide-item-img">
			                  <img src={publicUrl+"assets/img/slider/63.png"} alt="#" />
			                </div>
			              </div>
			            </div>
			          </div>
			          ...
			          <div className="container">
			            <div className="row">
			              <div className="col-lg-12 align-self-center">
			                ...
			                <div className="slide-item-img">
			                  <img src={publicUrl+"assets/img/slider/64.png"} alt="#" />
			                </div>
			              </div>
			            </div>
			          </div>
			      ...
			      <div className="ltn__slider-11-img-slide-arrow-inner">
			        <div className="ltn__slider-11-img-slide-arrow-active">
			          <div className="image-slide-item">
			            <img src={publicUrl+"assets/img/slider/61.png"} alt="Flower Image" />
			          </div>
			          <div className="image-slide-item">
			            <img src={publicUrl+"assets/img/slider/62.png"} alt="Flower Image" />
			          </div>
			          <div className="image-slide-item">
			            <img src={publicUrl+"assets/img/slider/63.png"} alt="Flower Image" />
			          </div>
			          <div className="image-slide-item">
			            <img src={publicUrl+"assets/img/slider/64.png"} alt="Flower Image" />
			          </div>
			        </div>
