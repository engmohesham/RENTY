    ...
    return <div className="ltn__team-details-area mb-120">
                ...
                <div className="row">
                    ...
                    <div className="ltn__team-details-member-info text-center mb-40">
                        ...
                        <img src={publicUrl+"assets/img/team/4.png"} alt="Team Member Image" />
                        </div>
                    ...
                    <div className="ltn__team-details-member-info-details">
                        ...
                        <form id="contact-form" action="mail.php" method="post">
                            ...
                            <button className="btn theme-btn-1 btn-effect-4 text-uppercase" type="submit">get an free service</button>
                            </div>
