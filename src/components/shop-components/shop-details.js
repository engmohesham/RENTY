            ...
            <div className="col-lg-8 col-md-12">
              <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                ...
                <div className="ltn__property-details-gallery mb-30">
                  <div className="row">
                    <div className="col-md-6">
                      <a
                        href={publicUrl + "assets/img/others/14.png"}
                      ...
                      <a
                        href={publicUrl + "assets/img/others/15.png"}
                        data-rel="lightcase:myCollection"
                      >
                        <img
                          className="mb-30"
                          src={publicUrl + "assets/img/others/15.png"}
                          alt="Image"
                        />
                      </a>
                    </div>
                    <div className="col-md-6">
                      <a
                        href={publicUrl + "assets/img/others/16.png"}
                        data-rel="lightcase:myCollection"
                      >
                        <img
                          className="mb-30"
                ...
                <div
                  ...
                  data-bs-bg={publicUrl + "assets/img/others/5.png"}
                >
                  <a
                      ...
                      <ul>
                        <li>
                          <div className="ltn__comment-item clearfix">
                            <div className="ltn__commenter-img">
                              <img
                                src={publicUrl + "assets/img/testimonial/1.png"}
                                alt="Image"
                              />
                            </div>
                        ...
                        <li>
                          <div className="ltn__comment-item clearfix">
                            <div className="ltn__commenter-img">
                              <img
                                src={publicUrl + "assets/img/testimonial/3.png"}
                                alt="Image"
                              />
                            </div>
                            <div className="ltn__commenter-comment">
                        ...
                        <li>
                          <div className="ltn__comment-item clearfix">
                            <div className="ltn__commenter-img">
                              <img
                                src={publicUrl + "assets/img/testimonial/2.png"}
                                alt="Image"
                              />
                            </div>
                            <div className="ltn__commenter-comment">
                    ...
                    <form action="#">
                      ...
                      <div className="mb-30">
                        <div className="add-a-review">
                          <h6>Your Ratings:</h6>
                          <div className="product-ratting" id="rate-div">
                            <div class="wrapper">
                              <form class="demoForm">
                                <div class="rating rating-large" dir="rtl">
                                  <input
                                    ...
                                    value="5"
                                  />
                                  <label class="rating-label" for="5">
                                  ...
                                  <input
                                    ...
                                    value="4"
                                  />
                                  <label class="rating-label" for="4">
                                    <i class="rating__icon rating__icon--star fa fa-star"></i>
                                  </label>
                                  <input
                                    type="radio"
                                    ...
                                    value="3"
                                  />
                                  <label class="rating-label" for="3">
                                    <i class="rating__icon rating__icon--star fa fa-star"></i>
                                  </label>
                                  <input
                                    type="radio"
                                    ...
                                    value="2"
                                  />
                                  <label class="rating-label" for="2">
                                    <i class="rating__icon rating__icon--star fa fa-star"></i>
                                  </label>
                                  <input
                                    type="radio"
                                    ...
                                    value="1"
                                  />
                                  <label class="rating-label" for="1">
                                    <i class="rating__icon rating__icon--star fa fa-star"></i>
                                  </label>
                                </div>
                              </form>
                  ...
                  <div className="col-xl-6 col-sm-6 col-12 go-top">
                    <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                      <div className="product-img">
                        <Link to="/shop">
                          <img
                            src={publicUrl + "assets/img/product-3/1.png"}
                            alt="#"
                          />
                        </Link>
                        <div className="real-estate-agent">
                          <div className="agent-img">
                            <Link to="/team-details">
                              <img
                                src={publicUrl + "assets/img/blog/author.png"}
                                alt="#"
                              />
                            </Link>
                          </div>
                      ...
                      <div className="product-info-bottom">
                        <div className="product-ratting mb-10">
                          <a>
                            <i className="fas fa-star" />
                          </a>
                          <a>
                  ...
                  <div className="col-xl-6 col-sm-6 col-12 go-top">
                    <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                      <div className="product-img">
                        <Link to="/shop">
                          <img
                            src={publicUrl + "assets/img/product-3/2.png"}
                            alt="#"
                          />
                        </Link>
                        <div className="real-estate-agent">
              ...
              <aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
                ...
                <div className="widget ltn__author-widget">
                  <div className="ltn__author-widget-inner text-center">
                    <img
                      src={publicUrl + "assets/img/team/4.png"}
                      alt="Image"
                    />
                    <h5>Rosal D. Willaimson</h5>
                ...
                <div className="widget ltn__form-widget">
                  ...
                  <form action="#">
                    ...
                    <textarea
                      ...
                      defaultValue={"Hello, I am interested in [Complex]"}
                    />
                    <button
                      type="submit"
                      className="btn theme-btn-1 btn-effect-4 col-7"
                    >
                      Send Messege
                    </button>
                    <a href="tel:01011560461" className="btn theme-btn-3 col-4">
                      Call
                    </a>
                    <a
                      href="https://wa.me/+201011560461?text=Hello,%20I%20am%20interested%20in%20[Complex]"
                      target="_blank"
                      className="btn theme-btn-1 btn-effect-4 col-12"
                    >
                    ...
                    <div className="col-12">
                      <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div className="product-img go-top">
                          <Link to="/shop">
                            <img
                              src={publicUrl + "assets/img/product-3/3.png"}
                              alt="#"
                            />
                          </Link>
                          <div className="real-estate-agent">
                      ...
                      <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div className="product-img">
                          <a href="product-details.html">
                            <img
                              src={publicUrl + "assets/img/product-3/4.png"}
                              alt="#"
                            />
                          </a>
                          <div className="real-estate-agent">
                    ...
                    <div className="col-12">
                      <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div className="product-img">
                          <a href="product-details.html">
                            <img
                              src={publicUrl + "assets/img/product-3/5.png"}
                              alt="#"
                            />
                          </a>
                          <div className="real-estate-agent">
                ...
                <div className="widget ltn__banner-widget d-none go-top">
                  <Link to="/shop">
                    <img src={publicUrl + "assets/img/banner/2.png"} alt="#" />
                  </Link>
                </div>
              </aside>
            </div>
