...
class Login extends Component {
  render() {
    ...
    return (
      <div>
        <div className="ltn__login-area pb-65 bg-overlay-black-70">
                ...
                <div className="account-login-inner">
                  <form method="GET" className="ltn__form-box contact-form-box">
                    ...
                    <div className="btn-wrapper mt-0">
                      <button
                        className="theme-btn-3 mt-10 btn btn-block"
                        type="submit"
                      >
                        SIGN IN
                      </button>
              ...
              <div className="col-lg-6">
                <div className="account-create text-center pt-50">
                  ...
                  <div className="btn-wrapper go-top">
                    <Link to="/register" className="theme-btn-3 btn black-btn">
                      CREATE ACCOUNT
                    </Link>
                  </div>
                </div>
                        ...
                        <div className="col-12">
                          <div className="modal-product-info text-center">
                            ...
                            <form action="#" className="ltn__form-box">
                              ...
                              <div className="btn-wrapper mt-0">
                                <button
                                  className="theme-btn-1 btn-effect-4 btn btn-full-width-2"
                                  type="submit"
                                >
                                  Submit
                                </button>
